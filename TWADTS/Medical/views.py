    ...
    if request.method == 'GET':
        ...
        if uname == Email:
            try:
                ...
                Medical_Data = Medical_History.objects.get(Email__Email=request.session['username'])
                ...
                Medical_Data=Medical_History(Email=Email,Complete_Name=Complete_Name,Hight=Hight,Weight=Weight,Blood_Pressure=Blood_Pressure,
                                             Emergency_Contact=Emergency_Contact,Address_Line1=Address_Line1,Address_Line2=Address_Line2,
                                             City=City,State=State,Postal_code=Postal_code,Past_Treatment=Past_Treatment,
                                             Past_Treatment_Description=Past_Treatment_Description,Past_Report=Past_Report,
                                             Past_Injury=Past_Injury,Past_Injury_Description=Past_Injury_Description,
                                             Past_Injury_Report=Past_Injury_Report,Genetic_Disorder=Genetic_Disorder,
                                             Genetic_Disorder_Description=Genetic_Disorder_Description,
                                             Genetic_Disorder_Report=Genetic_Disorder_Report,Ongoing_Medicine=Ongoing_Medicine,
                                             Ongoing_Medicine_Description=Ongoing_Medicine_Description,
                                             Ongoing_Medicine_Report=Ongoing_Medicine_Report,Other_Details=Other_Details,
                                             Other_Details_Description=Other_Details_Description,Other_Details_Report=Other_Details_Report )
                print("2")
                Medical_Data.save()
                print('3')
                info = {'Email1': Email, 'Complete_Name': Complete_Name, 'Weight': Weight, 'Hight': Hight,
